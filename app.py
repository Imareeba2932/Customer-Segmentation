...
if page == "Home":
    ...
    st.title("Welcome to the Customer Segmentation App 🎯")
    st.markdown("""
    **Discover the power of customer segmentation with machine learning!**
    ...
    st.markdown("### 🎉 Get started by exploring the app now!")
    st.button("Go to Customer Segmentation")
...
# Customer Segmentation Page
    ...
    st.markdown("Built with ❤️ using [Streamlit](https://streamlit.io/) and [Plotly](https://plotly.com/).")
